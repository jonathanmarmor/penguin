...
##                                'Katie', 'Beth', 'Jason']
    ...
    movement.harmonies = []
    movement.notes = {}
    movement.tempo_bpm = random.choice(range(62,91,4))
    ...
    movement.duration_of_segments = 256 #
...
def choose_sections_order(movement):
    ...
    if movement.tempo_bpm == 62: num_segs = 8
    if movement.tempo_bpm == 66: num_segs = 8
    if movement.tempo_bpm == 70: num_segs = 9
    if movement.tempo_bpm == 74: num_segs = 9
    if movement.tempo_bpm == 78: num_segs = 10
    if movement.tempo_bpm == 82: num_segs = 10
    if movement.tempo_bpm == 86: num_segs = 11
    if movement.tempo_bpm == 90: num_segs = 11
