...
##                                'Katie', 'Beth', 'Jason']
    ...
    movement.harmonies = []
    movement.notes = {}
    movement.tempo_bpm = random.choice(range(54,87,4))
...
def choose_sections_order(movement):
    ...
    if movement.tempo_bpm == 54: num_segs = random.choice([6, 7, 8])
    if movement.tempo_bpm == 58: num_segs = random.choice([7, 8, 9])
    if movement.tempo_bpm == 62: num_segs = random.choice([7, 8, 9])
    if movement.tempo_bpm == 66: num_segs = random.choice([7, 8, 9, 10])
    if movement.tempo_bpm == 70: num_segs = random.choice([8, 9, 10])
